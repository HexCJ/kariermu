      ...
      <div class="container-fluid px-4">
        <div class="row">
          <div class="col p-0">
            <div class="card mt-3">
              <div class="card-body">
                <div class="d-flex flex-column text-center d-flex justify-content-center align-items-center text-secondary min-vh-100">
                  <h3 class="fw-medium">Anda Belum Melaporkan Data Karir</h3>
                  <h5 class="">Segera Laporkan Karir Anda</h5>
                </div>
                {{-- jika ada --}}
                <div class="row">
                  <div class="col-12">
