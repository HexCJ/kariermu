...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12 mt-4">
      ...
      <!-- Modal Update -->
      <div class="modal fade" id="editDataJurusan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
          <div class="modal-content">
            <div class="modal-header">
                      ...
                      <tr>
                        ...
                        <td class="d-flex justify-content-end align-items-center">
                          <div class="dropdown py-3">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editDataJurusan"><i class="bi bi-person-fill-gear me-2 i-icon"></i>Edit</a></li>
                              {{-- <li><a href="" class="dropdown-item" href="#"><i class="bi bi-person-fill-dash me-2 i-icon"></i>Edit</a></li> --}}
                              <li>
                                <a href="#" class="dropdown-item text-danger" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete {{ $d->nama_jurusan }} this data?')) { document.getElementById('hapus-jurusan-{{ $d->id }}').submit(); }">
