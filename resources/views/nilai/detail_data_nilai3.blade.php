                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="bindo"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'BI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="mtk"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'MTK')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="bing"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'BING')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pai"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'PAI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="si"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'SI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="ipas"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'IPAS')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="sb"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'SB')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pkn"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'PKN')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pjok"
                                                        value="{{ $nilaiS3->where('mata_pelajaran', 'PJOK')->first()->nilai }}"
