            ...
            <div class="row">
                <div class="col-12 mt-4">
                    <div class="d-flex justify-content-between">
                        <h4 class="h4">Data Nilai Siswa Semester 2</h4>
            ...
            <div class="row">
                <div class="col-12 mt-4">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 mt-4">
                                <form action="{{ route('datanilai2.add') }}" method="POST">
                                    @csrf
                                    <div class="container-fluid mt-5">
                                        <div class="row">
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="bindo"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'BI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="mtk"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'MTK')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="bing"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'BING')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pai"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'PAI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="si"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'SI')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="ipas"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'IPAS')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="sb"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'SB')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pkn"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'PKN')->first()->nilai }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="pjok"
                                                        value="{{ $nilaiS2->where('mata_pelajaran', 'PJOK')->first()->nilai }}"
